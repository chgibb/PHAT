...
export class View extends viewMgr.View
{
    ...
    public displayInfo : "QCInfo" | "RefSeqInfo" | "AlignmentInfo" | "SNPPositions" | "MappedReadsPerContigInfo" | "BLASTRuns" | "BLASTSingleRun";
    public inspectingAlignUUID : string;
    public inspectingBLASTRunUUID : string;
