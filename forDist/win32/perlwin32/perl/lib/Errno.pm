...
our %EXPORT_TAGS = (
    ...
    WINSOCK => [qw(
	WSAEREFUSED WSAENETDOWN WSAENETRESET WSAENOBUFS WSAENAMETOOLONG
	WSAETIMEDOUT WSAESOCKTNOSUPPORT WSAEINVALIDPROVIDER WSAEBADF
	WSAEHOSTDOWN WSAENOMORE WSAEINVALIDPROCTABLE WSAEPFNOSUPPORT
	WSAECONNABORTED WSAECONNRESET WSAEREMOTE WSAEPROCLIM WSAEMSGSIZE
	WSAENOPROTOOPT WSAEMFILE WSAENOTEMPTY WSAEPROTONOSUPPORT WSAEFAULT
	WSAENETUNREACH WSAENOTSOCK WSAEINPROGRESS WSAESHUTDOWN WSAECANCELLED
	WSAEUSERS WSAEOPNOTSUPP WSAEDQUOT WSAENOTCONN WSAEDISCON WSAEPROTOTYPE
	WSAEHOSTUNREACH WSAEINVAL WSAEINTR WSAEALREADY WSAEADDRINUSE
	WSAEADDRNOTAVAIL WSAEAFNOSUPPORT WSAELOOP WSAEWOULDBLOCK WSAESTALE
	WSAEDESTADDRREQ WSAECONNREFUSED WSAETOOMANYREFS WSAEISCONN WSAEACCES
