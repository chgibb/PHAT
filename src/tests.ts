...
import {testBLASTSegment0To8000L6R7HPV16Alignment} from "./req/tests/testBLASTSegment0To8000L6R7HPV16Alignment";
...
async function runTests() : Promise<void>
{
	return new Promise<void>(async (resolve,reject) => {
		...
		try
		{
			await testBLASTSegment0To8000L6R7HPV16Alignment();
		}
		catch(err)
		{
			console.log("BLASTing segment threw exception");
